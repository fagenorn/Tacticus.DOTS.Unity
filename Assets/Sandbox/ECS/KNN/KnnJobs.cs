...
namespace Sandbox.ECS.KNN
{
    ...
    public struct QueryKNearestJob : IJob
    {
        ...
        void IJob.Execute() { m_container.QueryKNearest(m_queryPosition, m_result); }
    }
    ...
    public struct QueryRangeJob : IJob
    {
        ...
        void IJob.Execute() { m_container.QueryRange(m_queryPosition, m_range, m_result); }
    }
    ...
    public struct KnnRebuildJob : IJob
    {
        ...
        void IJob.Execute() { m_container.Rebuild(); }
    }
}