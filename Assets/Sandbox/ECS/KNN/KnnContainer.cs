...
namespace Sandbox.ECS.KNN
{
    ...
    public struct KnnContainer : IDisposable, INativeDisposable
    {
        ...
        public struct KnnQueryTemp : IDisposable
        {
            ...
            public void PushQueryNode(int index, float3 closestPoint, float3 queryPosition)
            {
                ...
                MinHeap.PushObjMin(new QueryNode { NodeIndex = index, TempClosestPoint = closestPoint, Distance = lengthsq }, lengthsq);
            }
        ...
        public JobHandle Dispose(JobHandle inputDeps)
        {
            ...
            var job1 = m_permutation.Dispose(inputDeps);
            var job2 = m_nodes.Dispose(inputDeps);
            var job3 = m_rootNodeIndex.Dispose(inputDeps);
            var job4 = m_buildQueue.Dispose(inputDeps);

            var job5 = JobHandle.CombineDependencies(job1, job2, job3);
            var job6 = JobHandle.CombineDependencies(job4, job5);
