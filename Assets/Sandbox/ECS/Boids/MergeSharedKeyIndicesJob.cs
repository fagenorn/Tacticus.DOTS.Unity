...
namespace Sandbox.ECS.Boids
{
    ...
    public static class JobNativeMultiHashMapUniqueHashExtensions
    {
        ...
        {
            var jobProducer = new JobNativeMultiHashMapMergedSharedKeyIndicesProducer<TJob> { HashMap = hashMap, JobData = jobData };
...
, ScheduleMode.Batched
            ...
            where TJob : struct, IJobNativeMultiHashMapMergedSharedKeyIndices
        {
            ...
            private delegate void ExecuteJobFunction(ref JobNativeMultiHashMapMergedSharedKeyIndicesProducer<TJob> jobProducer, IntPtr additionalPtr, IntPtr bufferRangePatchData, ref JobRanges ranges, int jobIndex);
